      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p className={styles.headingsDescription}>
            İstanbul&apos;un lider hafriyat firması olarak, her projede kalite, güvenlik ve verimlilik standartlarını en üst seviyede tutuyoruz. Profesyonel ekibimiz ve modern altyapımızla inşaat sektörünün güvenilir çözüm ortağıyız.
          </p>
        </div>
        ...
        <div  class={styles.content}>
          <p>
            Özer Hafriyat 2015 yılında İstanbul&apos;da kuruldu. Özer Hafriyat&apos;ın kurucusu olan Metin Özer babasının mesleği nedeniyle çocukluğundan itibaren inşaatlarda büyük tecrübe kazandı. İnşaatın hemen her alanında çalışan ve sonrasında oparetor olan Metin Özer, 2015 yılında Özer Hafriyat&apos;ı kurdu.            
            <br></br>
            <br></br>
            Özer Hafriyat olarak başarılı ve büyük hafriyat projelerinin üstesinden gelen köklü şirket, güncel olarak Kadıköy&apos;de bulunan Fikirtepe&apos;nin bütün altyapısının hafriyat yükünü tek başına sırtlamış ve bu süreci profesyonellikle yönetmektedir. Aynı zamanda şirkte Çekmeköy&apos;de bulunan hafriyat işlemlerini de aktif olarak yürütmektedir.
          </p>
        </div>
        ...
        <div className={styles.content}>
          <p>Şantiye alanlarından kentsel dönüşüm projelerine, inşaat hafriyatından altyapı çalışmalarına kadar geniş bir yelpazede hizmet veriyoruz. İstanbul&apos;un karmaşık inşaat projelerinde size profesyonel hafriyat desteği sağlıyoruz.</p>
        </div>
